...
* **A Grande Sacada de Segurança:** Durante o uso da IA, percebi que iria subir minha chave de API para o GitHub. Parei, consultei a IA sobre a melhor prática de segurança, e configurei o .gitignore para bloquear a pasta api/. Isso me provou que a IA é uma excelente ferramenta de apoio, mas a visão crítica de segurança deve ser sempre do desenvolvedor!