...
scraper_main_code = r"""package main
...
def inject():
    os.makedirs("cmd/scraper", exist_ok=True)
    with open("cmd/scraper/main.go", "w", encoding="utf-8") as f:
        f.write(scraper_main_code)

    os.makedirs("cmd/bonus_ai", exist_ok=True)
    with open("cmd/bonus_ai/main.go", "w", encoding="utf-8") as f:
        f.write(bonus_ai_code)

    print("SUCESSO: Todos os erros corrigidos. Arquivos atualizados:")
    print(" -> cmd/scraper/main.go")
    print(" -> cmd/bonus_ai/main.go")
